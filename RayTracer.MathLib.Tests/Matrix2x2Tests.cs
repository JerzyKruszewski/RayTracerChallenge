...
public class Matrix2x2Tests
{
                                                     ...
                                                     double arg10, double arg11)
    {
        ...
        Matrix2x2.Transpose(matrix)._matrix.Should().BeEquivalentTo(expected);
    }
                                                 ...
                                                 double arg10, double arg11)
    {
        ...
        Matrix2x2.Inverse(matrix)._matrix.Should().BeEquivalentTo(expected);
    }
                                                             ...
                                                             double arg10, double arg11)
    {
        ...
        (expected == Matrix2x2.Inverse(Matrix2x2.Inverse(matrix))).Should().BeTrue();
    }
}
